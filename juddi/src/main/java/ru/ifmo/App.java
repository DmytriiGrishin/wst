...
public class App {
    ...
    public static void main(String args[]) {
        String wsdl = "http://localhost:8081/SculptureService?wsdl";
        String businessKey = "uddi:localhost:0174084d-cbf1-44f2-af31-1b3c3ca7087d";
        String serviceName = "SculptureWebService";
        String serviceDescription = "Simple service for getting information about Sculptures";
        String serviceKey = "";
        ...
        if (client != null) {
            ...
            UDDIClerk clerk = client.getClerk("ifmo");
            try {

                ru.ifmo.Juddi juddi = new ru.ifmo.Juddi(client, clerk, businessKey);
                ...
                List<ru.ifmo.ServiceInformation> si = juddi.findServiceByName(serviceName);
    ...
    private static void displayServices(List<ru.ifmo.ServiceInformation> si) {
        for (ru.ifmo.ServiceInformation item : si) {
