...
public class App {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Query without auth: /sculptures, \nMethod: POST, \nData: name=Богатыри, author=Виктор Михайлович Васнецов, " +
        ...
        System.out.println("Query without auth: /sculptures/10, \nMethod: PUT, \nData: name=My own sculpture, author=ITMO, year=2018");
